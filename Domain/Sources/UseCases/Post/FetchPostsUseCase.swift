...
public protocol FetchPostsUseCase: Sendable {
    func execute(request: PostByLocationRequest) async throws -> ResponseListWithCursor<Post>
}
...
public final class FetchPostsUseCaseImpl: FetchPostsUseCase, @unchecked Sendable {
    ...
    public func execute(request: PostByLocationRequest) async throws -> ResponseListWithCursor<Post> {
